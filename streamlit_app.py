...
if "available_models" not in st.session_state:
    ...
    if response.status_code == 200:
        ...
        st.session_state.available_models = ["gpt-3.5-turbo"]  # Fallback option
    ...
    if st.button("Upload and Process File"):
        ...
        with st.spinner("Uploading and preprocessing file..."):
            ...
            if upload_response.status_code == 200:
                ...
                # Automatically preprocess the file
...
# Model selection (outside the chat interface to prevent rerunning)
