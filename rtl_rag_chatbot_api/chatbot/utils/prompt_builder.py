    ...
    def build_forced_answer_prompt(
        ...
        if query_type == "SIMPLE_AGGREGATION":
            ...
            instructions = (
                ...
                "6. For result sets = 25 rows:\n"
                "   - Append at the bottom: *Note: Results are limited to 25 rows for readability.*\n"
            ...
            instructions = (
                ...
                "5. For result sets = 25 rows:\n"
                "   - Append at the bottom: *Note: Results are limited to 25 rows for readability.*\n"
                "6. For large result sets (<26 rows):\n"
